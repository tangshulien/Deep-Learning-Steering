...
if __name__ == "__main__":
  from datag import datagen,label
  import argparse
  ...
  debugpath=['./n01440764/camera.h5']
  #debugpath=['./n01440764/20160130112451.h5']
  #debugpath=['/home/tom/dataset/camera/camera.h5']
  train_path =debugpath
 
  """
  #  for training
  #train_path = [
    #'/home/tom/dataset/camera/20160130112451.h5',
  ...
  #  for validation
  #validation_path =debugpath
  #validation_path = [
    #'/home/tom/dataset/camera/20160602213929.h5',
  ...
  gen = datagen(datapath,label, time_len=args.time, batch_size=args.batch,val=args.validation)
